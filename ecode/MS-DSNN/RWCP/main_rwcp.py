...
# from MSSNN import *
from rwcp_SpikeClassifier import*
...
# 根据ANN 初始化参数
ANN_dict = torch.load('rwcp_DNN.pth')
...
optimizer =torch.optim.Adam([
                {'params': snn.fc1_weight,'lr':learning_rate*0.1},
...
for epoch in range(num_epochs):
        ...
        for i,(images, labels) in enumerate(train_loader):
            ...
            batch = labels.size(0)  
            labels_ = torch.zeros(batch, 10).scatter_(1, labels.view(-1, 1), 1)
            outputs = snn(images)
