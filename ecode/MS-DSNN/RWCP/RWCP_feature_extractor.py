...
from RWCP_ParallelDeepSpikeFeatureExtractor import *
...
[train_x,train_y]=read('rwcp_CQT_train.pkl')
train_x = torch.tensor(train_x).float().unsqueeze(1)/24
train_y = torch.tensor(train_y).long()

[test_x,test_y]=read('rwcp_CQT_test.pkl')
test_x = torch.tensor(test_x).float().unsqueeze(1)/24
