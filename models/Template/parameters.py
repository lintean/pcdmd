...
args.data_document = device_to_use.splited_data_document + "/mb_kul_try_normal"
...
optimzer, device, scheduler, model, loss_func, myNet = None, None, None, None, None, None
