...
# args.data_document_path = cfg.origin_data_document + "/DTU_single_single_clean_1to32"
# args.data_document_path = device_to_use.origin_data_document + "/KUL_single_single_separate_1to32_new"
args.data_document_path = cfg.origin_data_document + "/SCUT_test"
args.load_model_path = f"{cfg.project_root_path}/result/cma_Encoder_clean_speech_2023-02-08_20_42_53"

# 输入数据选择
# label 为该次训练的标识
# ConType 为选用数据的声学环境，如果ConType = ["No", "Low", "High"]，则将三种声学数据混合在一起后进行训练
# names 为这次训练用到的被试数据
args.label = "cma_clean"
args.ConType =  ["No"]
...
args.cmaout, args.cmaout_act = True, True
...
if "DTU" or "SCUT" in args.data_document_path:
    args.process_steps = [preprocess_eeg_audio]
