...
# 所用的数据目录路径
data_document_path = origin_data_document + "/AAD_KUL"
...
# lr = 1e-4
lr = 1e-1
params = [{'params': myNet.conv.parameters(), 'lr': lr * 1},
          {'params': myNet.conference_CNN.parameters(), 'lr': lr},
          {'params': myNet.output_fc.parameters(), 'lr': lr * 1},
          {'params': myNet.fc.parameters(), 'lr': lr},
          {'params': myNet.cm_attn[0].in_proj_weight, 'lr': lr * 100},
          {'params': myNet.cm_attn[0].in_proj_bias, 'lr': lr},
          {'params': myNet.cm_attn[0].out_proj.parameters(), 'lr': lr * 100},
          {'params': myNet.cm_attn[1].in_proj_weight, 'lr': lr * 100},
          {'params': myNet.cm_attn[1].in_proj_bias, 'lr': lr},
          {'params': myNet.cm_attn[1].out_proj.parameters(), 'lr': lr * 100},
          {'params': myNet.cm_attn[2].in_proj_weight, 'lr': lr * 100},
          {'params': myNet.cm_attn[2].in_proj_bias, 'lr': lr},
          {'params': myNet.cm_attn[2].out_proj.parameters(), 'lr': lr * 100},
          # {'params': myNet.cm_attn[3].in_proj_weight, 'lr': lr * 100},
          # {'params': myNet.cm_attn[3].in_proj_bias, 'lr': lr},
          # {'params': myNet.cm_attn[3].out_proj.parameters(), 'lr': lr * 100},
          {'params': myNet.proj_images.parameters(), 'lr': lr},
          {'params': myNet.proj_images2.parameters(), 'lr': lr},
          {'params': myNet.proj_audio.parameters(), 'lr': lr * 10000},
          {'params': myNet.proj_audio2.parameters(), 'lr': lr * 10000},
          {'params': myNet.lstm.parameters(), 'lr': lr}]
# optimzer = torch.optim.Adam(params, lr=lr)
optimzer = torch.optim.SGD(params, lr=lr, weight_decay=0.0000001)
# print(optimzer)
