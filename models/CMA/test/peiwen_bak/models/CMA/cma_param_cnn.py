...
# 所用的数据目录路径
args.data_document_path = project.origin_data_document + "/KUL_multiple_single_origin_1to32"
# args.data_document_path = device_to_use.origin_data_document + "/KUL_single_single_separate_1to32"
args.load_model_path = f"{project.project_root_path}/result/cma_Encoder_separate_speech_2022-06-05_16_16_19"
...
# 模型相关参数
args.data_meta.audio_fs, data_meta.audio_fs, args.audio_fs = 8000, 8000, 8000
args.model_path = f"models.CNN.CNN_audio"
...
# 处理步骤
if args.encoder:
    args.process_steps = [read_extra_audio, subject_split]
else:
    args.process_steps = [read_eeg_wav, subject_split] if "separate" in args.data_document_path else [read_cma_data, subject_split]
args.process_steps += [add_reverse, remove_repeated]
