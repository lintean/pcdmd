...
# 所用的数据目录路径
args.data_document_path = ecfg.origin_data_document + "/KUL_single_single_clean_1to32_new"
...
# args.data_document_path = device_to_use.origin_data_document + "/KUL_single_single_separate_1to32_new"
args.load_model_path = f"{ecfg.project_root_path}/result/cma_Encoder_clean_speech_2023-02-08_20_42_53"
