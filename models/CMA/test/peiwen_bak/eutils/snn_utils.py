...
def FLOPS_snn_fc(data, c_in, orig_size):
...
def energy_snn_fc(data, c_in, orig_size):
    """
    ...
    """
    snn_energy_coefficient = 0.9
    FLOPs, spike, all = FLOPS_snn_fc(data=data, c_in=c_in, orig_size=orig_size)
    return FLOPs * snn_energy_coefficient, FLOPs, spike, all
