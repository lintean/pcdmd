...
class CNN(nn.Module):
    ...
    def forward(self, wavA, wavB, eeg):
        eeg = eeg.unsqueeze(0)
        eeg = eeg.unsqueeze(0)
        ...
        # audio, eeg = self.cross_modal(wavA, eeg, is_images=True, conv1D=True)
