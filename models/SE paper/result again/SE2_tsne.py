...
# 所用的数据目录路径
data_document_path = origin_data_document + "/dataset_fbcsp"

CNN_file = "./CNN_SEoutput.py"
...
vali_percent = 0.1
np.random.seed(seed)
split_seed = np.random.rand(len(ConType), trail_number)
np.random.seed()
